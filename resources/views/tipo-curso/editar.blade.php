...
<div class="container">
    ...
    <div class="mb-4">
        <h4 class="fs-2">Modificar tipo de curso</h4>
    </div>
    <form id="formulario">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <input type="text" name="nombre" value="{{$tipoCurso->nombre}}" class="form-control roboto-medium" placeholder="Ingresar nombre" required>
            </div>
            <div class="col-md-6">
                <label class="form-label fw-bolder roboto-medium">Orden <small class="required"></small></label>
                <input type="number" name="orden" value="{{$tipoCurso->orden}}" class="form-control roboto-medium" placeholder="Ingresar orden" required>
            </div>
        </div>
            ...
            <div class="col-md-6">
                ...
                <select name="habilitado" class="form-select roboto-medium" required>
                    ...
                    @foreach($estados as $item)
                        @if($tipoCurso->habilitado==$item->id)
...
$(document).ready(function() {
    ...
    var tipoCurso = {!! json_encode($tipoCurso) !!};
   

    var imagen = tipoCurso.imagen;
    if (imagen!=null) {
    ...
    $('#actualizar').on('click', function() {
        ...
        $.ajax({
            type: "POST",
            url: "{{url('tipo-curso/actualizar-tipo-curso')}}",
