...
@section('header')
<h1 class="text-white lh-base fw-bolder roboto-medium fs-1">Tipos de curso</h1>
@endsection
...
<div class="container">
    <div class="row align-items-center mt-5 mb-5">
        ...
        <div class="col-12 col-lg-6 d-flex justify-content-lg-end align-items-center flex-column flex-lg-row gap-3">
            ...
            <a href="{{url('tipo-curso/registrar')}}" class="btn btn-primary w-100 w-lg-auto d-flex align-items-center">
                Crear Nuevo
            </a>
        </div>
    </div>
...
$(document).ready(function() {
    ...
    function filtroTipoCurso()
    {
        ...
        $.ajax({
          type: "POST",
          url: "{{url('tipo-curso/listar-tipo-curso')}}",
          data: {search:search},
          success: function( response ) {
            ...
            if(nro_tipo_curso>1){
                $("#titulo").text(nro_tipo_curso+" Tipos de cursos ");
            }else{
                $("#titulo").text(nro_tipo_curso+" Tipo de curso");
            }
    ...
    eliminarTipoCurso = function(id){
        $.ajax({
            type: "POST",
            url: "{{url('tipo-curso/eliminar-tipo-curso')}}",
            data: {id: id},
            success: function( response ) {
                if (response.success) {
                    filtroTipoCurso();
