...
@section('header')
<h1 class="text-white lh-base fw-bolder roboto-medium fs-1">Portada incompany</h1>
@endsection
...
<div class="container">
    <div class="row align-items-center mt-5 mb-5">
        <div class="col-12 col-lg-6 d-flex align-items-center mb-lg-0">
            <a href="{{url('portada-incompany')}}" class="d-flex align-items-center text-decoration-none">
    ...
    <div class="mb-4">
        <h4 class="fs-2">Modificar portada incompany</h4>
    </div>
    <form id="formulario">
        ...
        <div class="row mt-3">
            <div class="col-md-6">
                <a href="{{url('portada-incompany')}}" class="btn btn-border-white">Cancelar</a>
...
$(document).ready(function() {
     ...
     $('#navPortadaInCompany').addClass('actived');
    ...
    $('#actualizar').on('click', function() {
        ...
        $.ajax({
            type: "POST",
            url: "{{url('portada-incompany/actualizar-portada-incompany')}}",
            ...
            success: function( response ) {
                if (response.success) {
                    ...
                    toastr.options.timeOut = 10000;
                    toastr.options.extendedTimeOut = 10000;
                    setTimeout(function(){window.location = "/portada-incompany"} , 2000);   
                }else{
