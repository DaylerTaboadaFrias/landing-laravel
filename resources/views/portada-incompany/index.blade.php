...
$(document).ready(function() {
    ...
    function filtroPortadaIncompany()
    {
        var search = $('#search').val();
        $.ajax({
          type: "POST",
          url: "{{url('portada-incompany/listar-portada-incompany')}}",
          data: {search:search},
          success: function( response ) {
            ...
            $("#titulo").text(nro_portada+" Portada incompany");
          },
    ...
    eliminarPortadaIncompany = function(id){
        $.ajax({
            type: "POST",
            url: "{{url('portada-incompany/eliminar-portada-incompany')}}",
            data: {id: id},
            success: function( response ) {
                if (response.success) {
                    filtroPortadaIncompany();
