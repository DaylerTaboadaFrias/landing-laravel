...
@section('header')
<h1 class="text-white lh-base fw-bolder roboto-medium fs-1">Características</h1>
@endsection
...
<div class="container">
    <div class="row align-items-center mt-5 mb-5">
        <div class="col-12 col-lg-6 d-flex align-items-center mb-lg-0">
            <a href="{{url('caracteristica-incompany')}}" class="d-flex align-items-center text-decoration-none">
    ...
    <div class="mb-4">
        <h4 class="fs-2">Modificar característica</h4>
    </div>
    <form id="formulario">
        ...
        <div class="row mt-3">
            <div class="col-md-6">
                ...
                <input type="text" name="nombre" value="{{$caracteristica->nombre}}" class="form-control roboto-medium" placeholder="Ingresar nombre" required>
            </div>
            <div class="col-md-6">
                <label class="form-label fw-bolder roboto-medium">Orden <small class="required"></small></label>
                <input type="number" name="orden" value="{{$caracteristica->orden}}" class="form-control roboto-medium" placeholder="Ingresar orden" required>
            </div>
        </div>
            ...
            <div class="col-md-6">
                ...
                <select name="habilitado" class="form-select roboto-medium" required>
                    ...
                    @foreach($estados as $item)
                        @if($caracteristica->habilitado==$item->id)
        ...
        <div class="row mt-3">
            <div class="col-md-6">
                <a href="{{url('caracteristica-incompany')}}" class="btn btn-border-white">Cancelar</a>
...
$(document).ready(function() {
     ...
     $('#navCaracteristicaInCompany').addClass('actived');
    ...
    var caracteristica = {!! json_encode($caracteristica) !!};


    var imagen = caracteristica.imagen;
    if (imagen!=null) {
    ...
    $('#actualizar').on('click', function() {
        ...
        $.ajax({
            type: "POST",
            url: "{{url('caracteristica-incompany/actualizar-caracteristica-incompany')}}",
            ...
            success: function( response ) {
                if (response.success) {
                    ...
                    toastr.options.timeOut = 10000;
                    toastr.options.extendedTimeOut = 10000;
                    setTimeout(function(){window.location = "/caracteristica-incompany"} , 2000);   
                }else{
