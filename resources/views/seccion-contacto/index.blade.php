...
$(document).ready(function() {
    ...
    function filtroSeccionContacto()
    {
        var search = $('#search').val();
        $.ajax({
          type: "POST",
          url: "{{url('seccion-contacto/listar-seccion-contacto')}}",
          data: {search:search},
          success: function( response ) {
            ...
            var nro_seccion_contacto = $("#tabla").DataTable().rows().count();
            $("#titulo").text(nro_seccion_contacto+" Sección contacto ");
          },
    ...
    eliminarSeccionContacto = function(id){
        $.ajax({
            type: "POST",
            url: "{{url('seccion-contacto/eliminar-seccion-contacto')}}",
            data: {id: id},
            success: function( response ) {
                if (response.success) {
                    filtroSeccionContacto();
