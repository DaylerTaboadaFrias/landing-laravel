...
@section('header')
<h1 class="text-white lh-base fw-bolder roboto-medium fs-1">Sección de inicio</h1>
@endsection
...
<div class="container">
    <div class="row align-items-center mt-5 mb-5">
        <div class="col-12 col-lg-6 d-flex align-items-center mb-lg-0">
            <a href="{{url('seccion-inicio')}}" class="d-flex align-items-center text-decoration-none">
    ...
    <div class="mb-4">
        <h4 class="fs-2">Modificar sección de inicio</h4>
    </div>
    <form id="formulario">
        ...
        <div class="row mt-3">
            <div class="col-md-6">
                ...
                <input type="text" name="titulo" value="{{$seccion->titulo}}" class="form-control roboto-medium" placeholder="Ingresar título" required>
            </div>
            <div class="col-md-6">
                <label class="form-label fw-bolder roboto-medium">Orden <small class="required"></small></label>
                <input type="number" name="orden" value="{{$seccion->orden}}" class="form-control roboto-medium" placeholder="Ingresar orden" required>
            </div>
        </div>
        ...
        <div class="row mt-3">
            <div class="col-md-12">
                ...
                <textarea name="descripcion" class="form-control roboto-medium" cols="3" rows="2" placeholder="Ingresar descripción"  required>{{$seccion->descripcion}}</textarea>
            </div>
        </div>
        ...
        <div class="row mt-3">
            <div class="col-md-12">
                <label class="form-label fw-bolder roboto-medium">Imagen </label>
                    ...
                    Para asegurar la calidad de la imagen debe cumplir con el siguiente peso: ser menor a 10MB y una dimensión aproximada: 74x74 px.
                    </div>
        ...
        <div class="row mt-3">
            <div class="col-md-6">
                <a href="{{url('seccion-inicio')}}" class="btn btn-border-white">Cancelar</a>
...
$(document).ready(function() {
    ...
    $('#actualizar').on('click', function() {
        ...
        $.ajax({
            type: "POST",
            url: "{{url('seccion-inicio/actualizar-seccion-inicio')}}",
            ...
            success: function( response ) {
                if (response.success) {
                    ...
                    toastr.options.timeOut = 10000;
                    toastr.options.extendedTimeOut = 10000;
                    setTimeout(function(){window.location = "/seccion-inicio"} , 2000);   
                }else{
