...
<div class="container">
    ...
    <div class="mb-4">
        <h4 class="fs-2">Crear nueva sección de inicio</h4>
    </div>
    <form id="formulario">
        ...
        <div class="row mt-3">
            <div class="col-md-12">
                ...
                <textarea name="descripcion" class="form-control roboto-medium" cols="3" rows="2" placeholder="Ingresar descripción" required></textarea>
            </div>
        </div>
...
$(document).ready(function() {
    ...
    $('#registrar').on('click', function() {
        ...
        $.ajax({
            type: "POST",
            url: "{{url('seccion-inicio/registrar-seccion-inicio')}}",
