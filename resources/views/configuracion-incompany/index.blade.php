...
$(document).ready(function() {
    ...
    function filtroConfiguracionIncompany()
    {
        var search = $('#search').val();
        $.ajax({
          type: "POST",
          url: "{{url('configuracion-incompany/listar-configuracion-incompany')}}",
          data: {search:search},
          success: function( response ) {
            ...
            var nro_configuracion_incompany = $("#tabla").DataTable().rows().count();
            $("#titulo").text(nro_configuracion_incompany+" Configuración incompany ");
          },
    ...
    eliminarConfiguracionIncompany = function(id){
        $.ajax({
            type: "POST",
            url: "{{url('configuracion-incompany/eliminar-configuracion-incompany')}}",
            data: {id: id},
            success: function( response ) {
                if (response.success) {
                    filtroConfiguracionIncompany();
