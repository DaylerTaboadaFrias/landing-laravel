...
<div class="container">
    ...
    <div class="mb-4">
        <h4 class="fs-2">Crear nueva opinión del estudiante</h4>
    </div>
    <form id="formulario">
        ...
        <div class="row mt-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="profesion" class="form-control roboto-medium" placeholder="Ingresar profesión" >
            </div>
        </div>
        <div class="row mt-3">
            <div class="col-md-12">
...
$(document).ready(function() {
    ...
    $('#registrar').on('click', function() {
        ...
        $.ajax({
            type: "POST",
            url: "{{url('curso/opinion-estudiante/registrar-opinion-estudiante')}}",
