...
<div class="container">
    <div class="row align-items-center mt-5 mb-5">
        <div class="col-12 col-lg-6 d-flex align-items-center mb-lg-0">
            <a href="{{url('/curso/pregunta-frecuente/'.$curso->id)}}" class="d-flex align-items-center text-decoration-none">
    ...
    <div class="mb-4">
        <h4 class="fs-2">Crear nueva pregunta frecuente</h4>
    </div>
    <form id="formulario">
        ...
        <div class="row mt-3">
            <div class="col-md-12">
                ...
                <textarea name="pregunta" class="form-control roboto-medium" cols="3" rows="3" placeholder="Ingresar pregunta"  required></textarea>
            </div>
        </div>
        ...
        <div class="row mt-3">
            <div class="col-md-12">
                ...
                <textarea name="respuesta" class="form-control roboto-medium" cols="3" rows="3" placeholder="Ingresar respuesta"  required></textarea>
            </div>
        </div>
        ...
        <div class="row mt-3">
            <div class="col-md-6">
                <a href="{{url('/curso/pregunta-frecuente/'.$curso->id)}}" class="btn btn-border-white">Cancelar</a>
...
$(document).ready(function() {
    ...
    $('#registrar').on('click', function() {
        ...
        $.ajax({
            type: "POST",
            url: "{{url('curso/pregunta-frecuente/registrar-pregunta-frecuente')}}",
            ...
            success: function( response ) {
                if (response.success) {
                    ...
                    setTimeout(function(){window.location = "/curso/pregunta-frecuente/"+curso.id} , 2000);   
                }else{
