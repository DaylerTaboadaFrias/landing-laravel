...
<div class="container">
    ...
    <div class="mb-4">
        <h4 class="fs-2">Crear nueva categoría</h4>
    </div>
    <form id="formulario">
        ...
        <div class="row mt-3">
            ...
            <div class="col-md-6">
                ...
                <input type="number" name="orden" class="form-control roboto-medium" placeholder="Ingresar orden" >
            </div>
...
$(document).ready(function() {
    ...
    $('#registrar').on('click', function() {
        ...
        $.ajax({
            type: "POST",
            url: "{{url('categoria-curso/registrar-categoria-curso')}}",
