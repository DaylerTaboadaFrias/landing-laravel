...
<div class="container">
    <div class="row align-items-center mt-5 mb-5">
        <div class="col-12 col-lg-6 d-flex align-items-center mb-lg-0">
            <a href="{{url('disponibilidad')}}" class="d-flex align-items-center text-decoration-none">
    ...
    <div class="mb-4">
        <h4 class="fs-2">Modificar disponibilidad</h4>
    </div>
    <form id="formulario">
        ...
        <div class="row mt-3">
            <div class="col-md-12">
                ...
                <input type="text" name="nombre" value="{{$disponibilidad->nombre}}" class="form-control roboto-medium" placeholder="Ingresar nombre" required>
            </div>
        </div>
        ...
        <div class="row mt-3">
            <div class="col-md-6">
                ...
                <input type="number" name="orden" value="{{$disponibilidad->orden}}" class="form-control roboto-medium" placeholder="Ingresar orden" >
            </div>
            <div class="col-md-6">
                ...
                <select name="habilitado" class="form-select roboto-medium" required>
                    ...
                    @foreach($estados as $item)
                        @if($disponibilidad->habilitado==$item->id)
        ...
        <div class="row mt-3">
            <div class="col-md-6">
                <a href="{{url('disponibilidad')}}" class="btn btn-border-white">Cancelar</a>
...
$(document).ready(function() {
    ...
    $('#actualizar').on('click', function() {
        ...
        $.ajax({
            type: "POST",
            url: "{{url('disponibilidad/actualizar-disponibilidad')}}",
            ...
            success: function( response ) {
                if (response.success) {
                    ...
                    setTimeout(function(){window.location = "/disponibilidad"} , 2000);   
                }else{
