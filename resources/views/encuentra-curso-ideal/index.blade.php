...
$(document).ready(function() {
    ...
    function filtroEncuentraCurso()
    {
        var search = $('#search').val();
        $.ajax({
          type: "POST",
          url: "{{url('encuentra-curso-ideal/listar-encuentra-curso-ideal')}}",
          data: {search:search},
          success: function( response ) {
            ...
            var nro_encuentra_curso = $("#tabla").DataTable().rows().count();
            $("#titulo").text(nro_encuentra_curso+" Encuentra tu curso ideal");
          },
    ...
    eliminarEncuentraCurso = function(id){
        $.ajax({
            type: "POST",
            url: "{{url('encuentra-curso-ideal/eliminar-encuentra-curso-ideal')}}",
            data: {id: id},
            success: function( response ) {
                if (response.success) {
                    filtroEncuentraCurso();
