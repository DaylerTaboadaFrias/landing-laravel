...
<div class="container">
    ...
    <div class="mb-4">
        <h4 class="fs-2">Modificar docente</h4>
    </div>
    <form id="formulario">
        ...
        <div class="row mt-3">
            <div class="col-md-4">
                ...
                <input type="text" name="prefijo_academico" value="{{$docente->prefijo_academico}}" class="form-control roboto-medium" placeholder="Lic,Msc,Dr,Ing,etc." required>
            </div>
            <div class="col-md-4">
                <label class="form-label fw-bolder roboto-medium">Nombre completo<small class="required"></small></label>
                <input type="text" name="nombre_completo" value="{{$docente->nombre_completo}}" class="form-control roboto-medium" placeholder="Ingresar nombre" required>
            </div>
        </div>
        <div class="row mt-3">
            <div class="col-md-4">
                <label class="form-label fw-bolder roboto-medium">Profesión  <small class="required"></small></label>
                <input type="text" name="profesion" value="{{$docente->profesion}}" class="form-control roboto-medium" placeholder="Ingresar profesión" required>
            </div>
            <div class="col-md-4">
                <label class="form-label fw-bolder roboto-medium">ID docente externo</label>
                <input type="text" name="id_docente_externo" value="{{$docente->id_docente_externo}}" class="form-control roboto-medium" placeholder="Ingresar ID docente externo" >
            </div>
        </div>
        <div class="row mt-3">
            <div class="col-md-12">
                <label class="form-label fw-bolder roboto-medium">Biografía  <small class="required"></small></label>
                <textarea name="biografia" class="form-control roboto-medium" cols="3" rows="5" placeholder="Ingresar biografía "  required>{{$docente->biografia}}</textarea>
            </div>
        </div>
        <div class="row mt-3">
            <div class="col-md-6">
                <label class="form-label fw-bolder roboto-medium">Enlace linkedin <small class="required"></small></label>
                <input type="text" name="enlace_linkedin" value="{{$docente->enlace_linkedin}}" class="form-control roboto-medium" placeholder="Ingresar enlace del linkedin" required>
            </div>
            <div class="col-md-6">
...
$(document).ready(function() {
    ...
    var docente = {!! json_encode($docente) !!};
   

    var imagen = docente.imagen;
    if (imagen!=null) {
    ...
    $('#actualizar').on('click', function() {
        ...
        $.ajax({
            type: "POST",
            url: "{{url('docente/actualizar-docente')}}",
