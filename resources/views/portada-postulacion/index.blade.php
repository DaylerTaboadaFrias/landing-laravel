...
$(document).ready(function() {
    ...
    function filtroPortadaPostulacion()
    {
        var search = $('#search').val();
        $.ajax({
          type: "POST",
          url: "{{url('portada-postulacion/listar-portada-postulacion')}}",
          data: {search:search},
          success: function( response ) {
            ...
            $("#titulo").text(nro_portada+" Portada postulación");
          },
    ...
    eliminarPortadaPostulacion = function(id){
        $.ajax({
            type: "POST",
            url: "{{url('portada-postulacion/eliminar-portada-postulacion')}}",
            data: {id: id},
            success: function( response ) {
                if (response.success) {
                    filtroPortadaPostulacion();
