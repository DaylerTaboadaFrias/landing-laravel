...
<tr>
    ...
    <td class="roboto-medium">
        ...
        <a href="{{ url('portada-postulacion/editar/'.$item->id) }}" data-bs-placement="top" title="Editar" class="btn btn-icon btn-primary"><i class="fas fa-pencil-alt fs-4 text-white"></i></a>
