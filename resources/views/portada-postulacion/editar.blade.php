...
@section('titulo')
<title>Portada postulación</title>
@endsection
...
@section('header')
<h1 class="text-white lh-base fw-bolder roboto-medium fs-1">Portada postulación</h1>
@endsection
...
<div class="container">
    <div class="row align-items-center mt-5 mb-5">
        <div class="col-12 col-lg-6 d-flex align-items-center mb-lg-0">
            <a href="{{url('portada-postulacion')}}" class="d-flex align-items-center text-decoration-none">
    ...
    <div class="mb-4">
        <h4 class="fs-2">Modificar portada postulación</h4>
    </div>
    <form id="formulario">
        ...
        <div class="row mt-3">
            <div class="col-md-6">
                <a href="{{url('portada-postulacion')}}" class="btn btn-border-white">Cancelar</a>
...
$(document).ready(function() {
     ...
     $('#navPortadaPostulacion').addClass('actived');
    ...
    $('#actualizar').on('click', function() {
        ...
        $.ajax({
            type: "POST",
            url: "{{url('portada-postulacion/actualizar-portada-postulacion')}}",
            ...
            success: function( response ) {
                if (response.success) {
                    ...
                    toastr.options.timeOut = 10000;
                    toastr.options.extendedTimeOut = 10000;
                    setTimeout(function(){window.location = "/portada-postulacion"} , 2000);   
                }else{
