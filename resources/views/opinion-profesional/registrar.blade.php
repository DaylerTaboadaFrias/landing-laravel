...
<div class="container">
    <div class="row align-items-center mt-5 mb-5">
        <div class="col-12 col-lg-6 d-flex align-items-center mb-lg-0">
            <a href="{{url('opinion-profesional')}}" class="d-flex align-items-center text-decoration-none">
    ...
    <div class="mb-4">
        <h4 class="fs-2">Crear nueva opinión profesional</h4>
    </div>
    <form id="formulario">
        ...
        <div class="row mt-3">
            <div class="col-md-12">
                ...
                <textarea name="opinion" class="form-control roboto-medium" cols="3" rows="2" placeholder="Ingresar opinión"  required></textarea>
            </div>
        </div>
        ...
        <div class="row mt-3">
            <div class="col-md-6">
                <a href="{{url('opinion-profesional')}}" class="btn btn-border-white">Cancelar</a>
...
$(document).ready(function() {
    ...
    $('#registrar').on('click', function() {
        ...
        $.ajax({
            type: "POST",
            url: "{{url('opinion-profesional/registrar-opinion-profesional')}}",
            ...
            success: function( response ) {
                if (response.success) {
                    ...
                    toastr.options.timeOut = 10000;
                    toastr.options.extendedTimeOut = 10000;
                    setTimeout(function(){window.location = "/opinion-profesional"} , 2000);   
                }else{
