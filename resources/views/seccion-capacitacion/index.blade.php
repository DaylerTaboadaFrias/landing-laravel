...
$(document).ready(function() {
    ...
    function filtroSeccionCapacitacion()
    {
        var search = $('#search').val();
        $.ajax({
          type: "POST",
          url: "{{url('seccion-capacitacion/listar-seccion-capacitacion')}}",
          data: {search:search},
          success: function( response ) {
            ...
            var nro_seccion_capacitacion = $("#tabla").DataTable().rows().count();
            $("#titulo").text(nro_seccion_capacitacion+" Sección de Capacitación");
          },
    ...
    eliminarSeccionCapacitacion = function(id){
        $.ajax({
            type: "POST",
            url: "{{url('seccion-capacitacion/eliminar-seccion-capacitacion')}}",
            data: {id: id},
            success: function( response ) {
                if (response.success) {
                    filtroSeccionCapacitacion();
