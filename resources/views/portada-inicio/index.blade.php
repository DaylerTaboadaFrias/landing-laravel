...
@section('titulo')
<title>Portadas de inicio</title>
@endsection
...
$(document).ready(function() {
    ...
    function filtroPortadaInicio()
    {
        var search = $('#search').val();
        $.ajax({
          type: "POST",
          url: "{{url('portada-inicio/listar-portada-inicio')}}",
          data: {search:search},
          success: function( response ) {
            ...
            $("#titulo").text(nro_portada+" Portada de inicio");
          },
    ...
    eliminarPortadaInicio = function(id){
        $.ajax({
            type: "POST",
            url: "{{url('portada-inicio/eliminar-portada-inicio')}}",
            data: {id: id},
            success: function( response ) {
                if (response.success) {
                    filtroPortadaInicio();
