...
@endsection
@section('header')
<h1 class="text-white lh-base fw-bolder roboto-medium fs-1">Subcategorías</h1>
@endsection
...
<div class="container">
    ...
    <div class="mt-5 mb-5">
        <h4 class="fs-2">Crear nueva subcategoría</h4>
    </div>
    <form id="formulario">
        <div class="row">
            <div class="col-md-6">
        ...
        <div class="row mt-3">
            <div class="col-md-6">
                ...
                <input type="number" name="orden" value="" class="form-control roboto-medium" placeholder="Ingresar orden" required>
            </div>
            <div class="col-md-6">
                <label for="habilitado" class="form-label fw-bolder roboto-medium roboto-medium">Habilitado <small class="required"></small></label>
...
$(document).ready(function() {
    ...
    $('#registrar').on('click', function() {
        ...
        $.ajax({
            type: "POST",
            url: "{{url('subcategoria-curso/registrar-subcategoria-curso')}}",
