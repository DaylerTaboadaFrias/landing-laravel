...
<div class="container">
    ...
    <div class="mb-4">
        <h4 class="fs-2">Modificar galería de inicio</h4>
    </div>
    <form id="formulario">
        ...
        <div class="row mt-3">
            <div class="col-md-6">
                ...
                <input type="text" name="enlace" value="{{$galeria->enlace}}" class="form-control roboto-medium" placeholder="Ingresar enlace">
            </div>
            <div class="col-md-6">
                <label class="form-label fw-bolder roboto-medium">Orden <small class="required"></small></label>
                <input type="number" name="orden" value="{{$galeria->orden}}" class="form-control roboto-medium" placeholder="Ingresar orden" required>
            </div>
        </div>
...
$(document).ready(function() {
    ...
    $('#actualizar').on('click', function() {
        ...
        $.ajax({
            type: "POST",
            url: "{{url('galeria-inicio/actualizar-galeria-inicio')}}",
